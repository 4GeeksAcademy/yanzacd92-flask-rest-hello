...
Revision ID: 968b39e56fc1
Revises: 0ebbaa17bf2d
Create Date: 2023-05-18 00:35:09.462743
...
revision = '968b39e56fc1'
down_revision = '0ebbaa17bf2d'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('residents_id', sa.Integer(), nullable=True),
    sa.Column('url', sa.String(length=250), nullable=True),
    sa.Column('created', sa.DateTime(), nullable=True),
    sa.Column('edited', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['residents_id'], ['people.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
